...
export default function Sidebars() {
  return (
    <>
      ...
      <div className="sidebar-left" style={{ position: 'fixed', left: '2rem', bottom: 0, zIndex: 40, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' }}>
      ...
      {/* Right Sidebar: Email */}
      <div className="sidebar-right" style={{ position: 'fixed', right: '2rem', bottom: 0, zIndex: 40, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <span style={{ fontFamily: 'monospace', fontSize: '0.9rem', marginBottom: '1rem', color: 'var(--color-slate)', writingMode: 'vertical-lr', transform: 'rotate(180deg)' }}>
          ©2025 Deepesh N
        </span>
        <div style={{ width: '1px', height: '6rem', background: 'var(--color-slate)', marginTop: '1rem' }} />
      </div>
